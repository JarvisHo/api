                        ...
                        <div class="col-lg-12">
                            ...
                            <? $attributes = array('id' => 'article','data-parsley-validate'=>'');
                               echo form_open('admin/email/update/'.$article_hash_id, $attributes);?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <?foreach($category AS $unit):?>
                                            <div class="col-lg-3"><input type="radio" name="article_task_category" value="<?=$unit['category_id']?>" <?if($article_task_category==$unit['category_id'])echo "checked='checked'"?>> <?=$unit['category_name']?> &nbsp;</div>
                                        <?endforeach?>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>本文狀態</label>：
                                    <input type="radio" name="article_status" value="0" <?if($article_status==0)echo "checked='checked'"?>> Disable &nbsp;
                                    <input type="radio" name="article_status" value="1" <?if($article_status==1)echo "checked='checked'"?>> Active &nbsp;
