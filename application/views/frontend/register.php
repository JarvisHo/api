            ...
            <div class="sub-info span-8 small-span-12">
                ...
                <div class="sub-signup">
                    <h3>快速加入會員</h3>
                        ...
                        echo form_hidden(array('action' => 'register')); ?>
                        <fieldset>
                            <legend>創立帳號</legend>
                            <table class="sub-signup_form span-12">
                                ...
                                <tr>
                                    ...
                                    <td class="span-7 mt">
                                        <input required="required" class="span-12" type="password" name="new_password"
                                               ...
                                               data-parsley-length="[8, 20]" data-parsley-Pattern="/^[a-zA-Z0-9]*$/">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="span-4 mt tar">
                                ...
                                <tr>
                                    <td class="span-12 mt tar" style="text-align: center">
                                        ...
                                        <a href="<?=base_url()?>store" class="button button-highlight button-rounded disabled" style="color:#3c3c3c;border: solid 1px #3c3c3c; cursor: pointer">回到商店選購</a>
                                        <?}?>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <?=form_hidden(array('source' => 'register'))?>
                        <fieldset>
                                ...
                                <tr>
                                    ...
                                    <td class="span-7 mt">
                                        <input required="required" class="span-12" type="email" name="email" id="email"
                                               value="<?if(isset($member_account))echo $member_account;?>" placeholder="eg. service@pawmaji.com"
